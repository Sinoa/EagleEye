...
public static class OnnxUtility
{
    ...
    public static TensorProto CreateTensor(string name, float[] data)
        => CreateTensorProtoCore(name, MemoryMarshal.AsBytes(data.AsSpan()), data.Length);
    ...
    public static TensorProto CreateTensor(string name, float[,] data)
    {
        ...
        return CreateTensorProtoCore(name, MemoryMarshal.AsBytes(FlattenArray(data)), dim0, dim1);
    }
    ...
    public static TensorProto CreateTensor(string name, float[,,] data)
    {
        ...
        return CreateTensorProtoCore(name, MemoryMarshal.AsBytes(FlattenArray(data)), dim0, dim1, dim2);
    }
    ...
    public static TensorProto CreateTensor(string name, float[,,,] data)
    {
        ...
        return CreateTensorProtoCore(name, MemoryMarshal.AsBytes(FlattenArray(data)), dim0, dim1, dim2, dim3);
    }
    ...
    public static TensorProto CreateTensor(string name, float[] data, params long[] dims)
        => CreateTensorProtoCore(name, MemoryMarshal.AsBytes(data.AsSpan()), dims);
    ...
    /// <param name="dims">各次元のサイズ</param>
    /// <returns>構成された<see cref="TensorProto"/>インスタンス</returns>
    private static TensorProto CreateTensorProtoCore(string name, ReadOnlySpan<byte> data, params long[] dims)
    {
        var tensorProto = CreateBaseTensorProto(name);
        ...
        tensorProto.RawData = ByteString.CopyFrom(data);
        return tensorProto;
    }
