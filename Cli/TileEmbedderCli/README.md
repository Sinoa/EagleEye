...
- [使用方法](#使用方法)
  - [基本構文](#基本構文)
  - [基本オプション](#基本オプション)
  - [ハイパーパラメータオプション](#ハイパーパラメータオプション)
  - [可視化オプション](#可視化オプション)
- [使用例](#使用例)
  - [1. ルールベースのみで生成（最もシンプル）](#1-ルールベースのみで生成最もシンプル)
  - [2. 牌譜ディレクトリから追加学習](#2-牌譜ディレクトリから追加学習)
  - [3. サブディレクトリを含めて学習](#3-サブディレクトリを含めて学習)
  - [4. JSON形式のみで出力](#4-json形式のみで出力)
  - [5. カスタムハイパーパラメータで学習](#5-カスタムハイパーパラメータで学習)
  - [6. 高速テスト実行](#6-高速テスト実行)
  - [7. PCAで2次元可視化（学習時）](#7-pcaで2次元可視化学習時)
  - [8. UMAPで2次元可視化（学習時）](#8-umapで2次元可視化学習時)
...
- [トラブルシューティング](#トラブルシューティング)
  - [牌譜ディレクトリが見つからない](#牌譜ディレクトリが見つからない)
  - [不正なパラメータ値](#不正なパラメータ値)
  - [出力形式のエラー](#出力形式のエラー)
- [ライセンス](#ライセンス)
- [関連プロジェクト](#関連プロジェクト)
